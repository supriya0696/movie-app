    ...
    constructor(props){
       ...
       classes(){
        ...
        for(let i = 0; i<this.props.data.length;i++){
           ...
           return designClass += this.props.data[i].completed ? "primary" : "warning"
        }
    ...
    render(){     
       const foo = ()=>{}     
        ...
        <div className="container">
            <div className="row">
                <div className="col">
            <div>{this.props.data.map(item=><button className={this.classes()} key={item}
                onClick={()=>this.props.onClickTable(item)}>{item.id}
